"""Переносит фотографии новостей из папки data/photos в site/assets/img.
...
Запуск: python tools/news/photos.py [--dry] [--src ПУТЬ] [--file ПУТЬ --for ИД-НОВОСТИ]
"""
import argparse
import hashlib
import pathlib
...
from lib.paths import IMG, NEWS as STORE, PHOTOS as SRC
from lib.store import load
from news.form import write_store  # порядок новостей и запись хранилища живут там
