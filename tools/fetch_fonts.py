"""Складывает шрифты Inter и Roboto в репозиторий и собирает assets/css/fonts.css.
...
Запуск: python tools/fetch_fonts.py
После запуска имена файлов меняются (в имени хэш содержимого), поэтому проверьте ссылки
rel="preload" в head страниц.
"""
import hashlib
import pathlib
import re
...
def main():
    ...
    header = (
        ...
        "   Файл собран скриптом tools/fetch_fonts.py, подмножества латиница и кириллица.\n"
        "   Обновить: python tools/fetch_fonts.py */\n\n"
    )
