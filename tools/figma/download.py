...
from lib.paths import FIGMA, SITE
MANIFEST = FIGMA / "assets_manifest.txt"
...
for line in MANIFEST.read_text(encoding="utf-8").splitlines():
    ...
    target = FIGMA / name.removeprefix("design/") if name.startswith("design/") else SITE / "assets" / name
